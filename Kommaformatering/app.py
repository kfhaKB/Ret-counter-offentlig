...
uploaded_file = st.file_uploader("Upload en fil (max 100 MB), ellers kan hjemmesiden ikke håndtere det. Send i stedet filen direkte til analysegruppen.", type=["csv", "xlsx", "txt", "json","tsv"])
